...
import com.example.jeffg.adapter.ReviewAdapter;
import com.example.jeffg.adapter.TrailerAdapter;
import com.example.jeffg.model.Movie;
import com.example.jeffg.model.Review;
import com.example.jeffg.model.Trailer;
import com.example.jeffg.popularmoviesapp.databinding.ActivityDetailBinding;
...
import static com.example.jeffg.popularmoviesapp.MainActivity.isFavorited;
import static com.example.jeffg.popularmoviesapp.MainActivity.mContext;
...
public class DetailActivity extends AppCompatActivity  {
    ...
    public boolean isFavorited(){
        ...
        Cursor mCursor = getContentResolver().query(com.example.jeffg.data.MovieContract.MovieEntry.CONTENT_URI,
                null,
                null,
                null,
                com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_ID);
        if (mCursor != null){
    ...
    private void deleteMovieData() {
        ...
        Uri uri = com.example.jeffg.data.MovieContract.MovieEntry.CONTENT_URI;
    ...
    private void saveMovieData() {
        ...
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_ID, movieDataReceived.getmId());
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_TITLE, movieDataReceived.getmTitle());
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_IMAGE, URL_IMAGE_PATH_LARGE.concat(movieDataReceived.getmMoviePoster()));
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_PLOT, movieDataReceived.getmPlot());
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_RATING, movieDataReceived.getmRating());
        contentValues.put(com.example.jeffg.data.MovieContract.MovieEntry.COLUMN_RELEASE, movieDataReceived.getmReleaseDate());
        getContentResolver().insert(com.example.jeffg.data.MovieContract.MovieEntry.CONTENT_URI, contentValues);
        idToast=0;
        toastMessages();
