package com.example.jeffg.adapter;
...
import com.example.jeffg.popularmoviesapp.DetailActivity;
...
public class MovieAdapterFavorites extends RecyclerView.Adapter<MovieAdapterFavorites.MovieHolder>{
    ...
    public MovieAdapterFavorites(ArrayList<String[]> arrayList, Context context, MainActivity movieClickListener){
        DetailActivity.arrayListMovies = arrayList;
        mContext = context;
        mMovieClickListener= (MovieClickListener) movieClickListener;
